...
# Clean deal notes AFTER df_sf is finalized
...
# Apply flattening to API-native fields
...
# Combine flattened fields into the main DataFrame
...
for _, row in df_mapping.iterrows():
    ...
    if export_col in df_sf.columns and (pd.isna(api_field) or api_field.strip() == ""):
        # Use pre-populated column if it exists
...
# === SAVE FINAL OUTPUT ===
output_data.to_csv(output_file, index=False, quoting=1)  # quoting=csv.QUOTE_ALL
