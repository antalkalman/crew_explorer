...
if "df" not in st.session_state:
    df_loaded = pd.read_excel("/Users/kalmanantal/Dropbox (Personal)/WORK/Pioneer Pictures/Adatbázis/visual_test/data_for_visual_test.xlsx")
...
for dept in filtered_df["Department"].dropna().unique():
    ...
    st.dataframe(dept_df_display[display_cols], use_container_width=True)
...
if st.button("💾 Save Changes to Excel"):
    ...
    folder = "/Users/kalmanantal/Dropbox (Personal)/WORK/Pioneer Pictures/Adatbázis/visual_test/"
